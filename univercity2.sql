-- Active: 1694603789152@@127.0.0.1@5432@university
CREATE TABLE
...
INSERT INTO
    University.Enrollments(student_id, course_id)
VALUES
('1', '1'), ('2', '1'), ('3', '2'), ('4', '3'), ('1', '3');
...
INSERT INTO
    University.Grades(grade, student_id, course_id)
VALUES
('67', '1'), ('98', '2',), ('100', '3'), ('95', '4'), ('89', '5');
